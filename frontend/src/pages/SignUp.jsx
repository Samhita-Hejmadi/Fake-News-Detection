            ...
            <div className="w-full max-w-md animate-fade-in-up">
                <div className="glass-panel rounded-3xl overflow-hidden shadow-2xl shadow-indigo-100 border border-white/60">
                    <div className="p-10">
                        ...
                        <h2 className="text-3xl font-extrabold text-center text-slate-900 mb-2 tracking-tight">Create Account</h2>
                        <p className="text-center text-slate-500 mb-8 font-medium">Join us to start verifying news.</p>
                        ...
                        <form onSubmit={handleSignUp} className="space-y-4">
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        type="text"
                                        required
                                        className="w-full pl-11 pr-4 py-3 bg-white/50 border border-slate-200/80 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-slate-900 shadow-sm"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3.5 mt-6 bg-slate-900 text-white font-bold rounded-xl hover:bg-indigo-600 transition-all shadow-md hover:shadow-xl hover:-translate-y-0.5 disabled:bg-slate-400 disabled:transform-none disabled:shadow-none"
                            >
